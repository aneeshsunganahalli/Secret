...
const Contact: React.FC<ContactProps> = ({ className = '' }) => {
  ...
  return (
    <motion.div 
      ...
      animate="visible"
    >
      {/* Main Contact Article - Animates Second */}
      <motion.div 
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-primary-colour rounded-full flex items-center justify-center">
          ...
          <div className="space-y-3">
            <h3 className="font-medium text-gray-900">Follow Me</h3>
            <div className="flex space-x-3">
              <a href="#" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-primary-colour hover:text-white transition-colors">
